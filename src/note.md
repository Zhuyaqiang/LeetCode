...
| 题目                                          | 解法                               | 难度   | 自解 | 其他解 | 复习 |
| --------------------------------------------- | ---------------------------------- | ------ | ---- | ------ | ---- |
| 792 匹配子序列的单词数                        | 暴力法(超时), 桶                   | Medium | ×    | ○○     |      |
| 775 全局倒置与局部倒置                        |                                    | Medium | ×    | ○○     |      |
| 769 最多能完成排序的快                        |                                    | Medium | √    | ○      |      |
| 766 托普利茨矩阵                              |                                    | Easy   | √    | ○      |      |
| 747 至少是其他数字两倍的最大数                |                                    | Easy   | √    |        |      |
| 746 使用最小花费爬楼梯                        | 动态规划                           | Easy   | √    |        |      |
| 729 我的日程安排表1                           | 暴力法, 二叉树(TreeMap)            | Medium | √    | ○      |      |
| 724 寻找数组的中心索引                        |                                    | Easy   | √    | ○      |      |
| 718 最长重复子数组                            | 暴力法(超时), 动态规划             | Medium | ×    | ○      |      |
| 717 1比特与2比特字符                          | 线性, 贪心                         | Easy   | √    | ○      |      |
| 714 买卖股票的最佳时机, 含手续费              | 动态规划                           | Medium | ×    | ○      |      |
| 713 乘积小于K的子数组                         | 滑动窗口                           | Medium | ×    | ○      |      |
| 697 数组的度                                  | 哈希表                             | Easy   | √    | ○      |      |
| 695 岛屿的最大面积                            | 深度优先(栈, 递归), 广度优先(队列) | Medium | √    | ○○○    |      |
| 674 最长连续递增序列                          |                                    | Easy   | √    |        |      |
| 670 最大交换                                  |                                    | Medium | √    |        |      |
