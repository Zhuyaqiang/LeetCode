...
public class A0098 {
    public static void main(String[] args) {
        ...
        System.out.println(rIsValidBST(root));  // true
        TreeNode root1 = new TreeNode(5);
        root1.left = new TreeNode(1);
        root1.right = new TreeNode(4);
        root1.right.left = new TreeNode(3);
        root1.right.right = new TreeNode(6);
        System.out.println(rIsValidBST(root1));  // false
        ...
        System.out.println(rIsValidBST(root2));   //true
    ...
    public static boolean rIsValidBST(TreeNode root) {
...
//            return true;
//        }
//        return recursion(root.left, root.val, Integer.MIN_VALUE) && recursion(root.right, Integer.MAX_VALUE, root.val);
    }

    public static boolean recursion(TreeNode root, long max, long min) {
        if (root == null) {
            return true;
        }
        ...
        boolean res = true;
        if (root.left != null) {
            res &= recursion(root.left, Math.min(max, root.val), min);
        }
        if (!res) {
            return false;
        }
        if (root.right != null) {
            res &= recursion(root.right, max, Math.max(min, root.val));
        }
        return res;
    }
